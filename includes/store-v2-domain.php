...
function daszek_v2_build_case_record($case_patch, $existing_case = [], $signal = null) {
    ...
    return [
        ...
        'superseded_facts' => daszek_v2_pick_json_value(isset($case_patch['superseded_facts']) ? $case_patch['superseded_facts'] : [], isset($existing_case['superseded_facts']) ? $existing_case['superseded_facts'] : [], []),
        'install_prep' => daszek_v2_pick_json_value(isset($case_patch['install_prep']) ? $case_patch['install_prep'] : [], isset($existing_case['install_prep']) ? $existing_case['install_prep'] : [], []),
...
function daszek_v2_build_desk_note_record($desk_note_patch, $existing_note = [], $signal = null) {
    ...
    return [
        ...
        'superseded_facts' => daszek_v2_pick_json_value(isset($desk_note_patch['superseded_facts']) ? $desk_note_patch['superseded_facts'] : [], isset($existing_note['superseded_facts']) ? $existing_note['superseded_facts'] : [], []),
        'install_prep' => daszek_v2_pick_json_value(isset($desk_note_patch['install_prep']) ? $desk_note_patch['install_prep'] : [], isset($existing_note['install_prep']) ? $existing_note['install_prep'] : [], []),

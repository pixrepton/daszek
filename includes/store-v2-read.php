...
function daszek_v2_build_case_read_item($case) {
    ...
    return [
        ...
        'superseded_facts' => isset($case['superseded_facts']) ? $case['superseded_facts'] : [],
        'install_prep' => isset($case['install_prep']) ? $case['install_prep'] : [],
...
function daszek_v2_build_note_card($note, $cases) {
    ...
    return [
        ...
        'superseded_facts' => isset($note['superseded_facts']) ? $note['superseded_facts'] : [],
        'install_prep' => isset($note['install_prep']) ? $note['install_prep'] : [],
